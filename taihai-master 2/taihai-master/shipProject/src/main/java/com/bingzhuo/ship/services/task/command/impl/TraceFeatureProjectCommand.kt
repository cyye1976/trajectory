...
class TraceFeatureProjectCommand(val inputPath:String?, val outputPath:String?, var pyFilePrefix: String = "", var allPrefix: String = ""): AbstractPythonCommand<Any?>() {
    ...
    override fun getCommand(): String {
        return "${getPyFilePathPrifix()}2.py"
    }
